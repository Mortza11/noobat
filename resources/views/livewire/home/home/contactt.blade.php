        ...
        <div class="content">
            ...
            <form
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" wire:model.lazy="category1.name" name="name" placeholder="نام" required>
                        <i class='fas fa-user'></i>
                    </div>
                    <div class="field">
                        <input type="text" wire:model.lazy="category1.lname" name="lname" placeholder="نام خانوادگی"
                               required>
                        <i class='fas fa-user'></i>
                    </div>
                    ...
                    <div class="field">
                        <input type="number" wire:model.lazy="category1.number" placeholder="شماره تماس ">
                    ...
                    <div class="select-box">
                        ...
                        {{--                        <select wire:model="category.time" name="time" name="name" class="form-control">--}}
                    ...
                    <div class="field">
                        <input type="number" wire:model.lazy="category1.National_Code" placeholder="کدملی ">
                        <i class='fas fa-phone-alt'></i>
                    </div>

                    <div class="form-group" style="padding-left: 4%">
                        <div class="notificationGroup">
                            <input id="option4" type="checkbox" wire:model.lazy="category1.for_whom" name="status"
                                   class="form-control">
