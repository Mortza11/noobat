...
<section class="home" id="home">
    ...
    <div class="content">
        <h2>سلام به سایت ,<br/>کلینیک <span>المیرا</span> خوش آمدید</h2>
        <p><span class="typing-text"></span>ما توی کار</p>
        <a href="#about" class="btn"><span>در باره ما </span>
    ...
    <div class="image">
        <img draggable="false" class="tilt" src="{{asset('home/assets/images/hero.png')}}" alt="">
    </div>
</section>
<!-- hero section ends -->
